...
/**
 * Matches `PrivacyConsentControllerModule.Companion.a(LegislationOperations, Lazy<OTPrivacyConsentController>)` —
 * the Dagger `@Provides` method that selects between the real OneTrust-backed controller and `NoopPrivacyConsentController`.
 */
